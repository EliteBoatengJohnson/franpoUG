...
class Claim:
    def __init__(self, request):
        ...
        if not claim:
            # save an emptyclaim request in the session 
            claim = self.session[settings.CLAIM_SESSION_ID]={}
        self.claim = claim

    def add(self,product,quantity=1,override_quantity=False):
        """This Method adds a Item or proudct to the cart or update its quantity"""
    ...
    def __iter__(self):
        """This Itereate over the items in the cart and get the products from the database"""
